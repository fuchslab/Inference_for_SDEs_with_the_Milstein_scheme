...
par(mar=c(2, .2, .2, .2))
plot(t,Y_euler[1,], type='l',ylim=yaxis,xlim=c(t_min-.05,t_max+.05), xlab = '', ylab ='', yaxt='n', xaxt = 'n')
for (j in 2:n) # paths
{ lines(t,Y_euler[j,])
}
...
par(mar=c(2, .2, .2, .2))
plot(t,Y_MB[1,], type='l',ylim=yaxis,xlim=c(t_min-.05,t_max+.05), xlab = '', ylab ='', yaxt='n', xaxt = 'n')
for (j in 2:n) # paths
{ lines(t,Y_MB[j,])
}
...
par(mar=c(2, .2, .2, .2))
plot(t,Y_Miltein[1,], type='l',ylim=yaxis,xlim=c(t_min-.05,t_max+.05), xlab = '', ylab ='', yaxt='n', xaxt = 'n')
for (j in 2:n) # paths
{ lines(t,Y_Miltein[j,])
}
lines(c(t_min,t_max),c(x_0,x_m),type='p',pch=20, col=2)
...
par(mar=c(2, .2, .2, .2))
plot(t,Y_MBMilstein[1,], type='l',ylim=yaxis,xlim=c(t_min-.05,t_max+.05), xlab = '', ylab ='', yaxt='n', xaxt = 'n')
for (j in 2:n) # paths
