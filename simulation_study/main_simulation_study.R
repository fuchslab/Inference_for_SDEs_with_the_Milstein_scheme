...
if (length(inputArgs)){
  ...
  methodPathUpdate <- inputArgs[5]  # "leftConditioned", "MB"
  ...
  # folder containing the file with obvervations
  obsFolder <- "GBM_alpha_1_sigma_0.25" # GBM_alpha_-5_sigma_0.25 GBM_alpha_-5_sigma_4 GBM_alpha_1_sigma_0.25 GBM_alpha_1_sigma_4 GBM_alpha_10_sigma_0.25 GBM_alpha_10_sigma_4)
  # number of observations to be used
  M <- 25 # , 50, 100, 1000
  # number of imputed points in each inter-observation interval
  m <- 2 # , 10
  ...
  methodPathUpdate <- "MB" # "leftConditioned", "MB"
