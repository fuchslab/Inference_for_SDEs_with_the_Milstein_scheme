...
v_methodPathUpdate=(leftConditioned MB)
v_approxTransDens=(Euler Milstein)
v_approxPropDens=(Euler Milstein)
                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            /home/icb/susanne.pieschner/R/sim_study_CIR/simulation_study/execute_main_file.sh $obsFolder $M $m $numIterations $methodPathUpdate $approxTransDens $approxPropDens  $index
